...
<%ConectaBD conexion=new ConectaBD();
    ...
    PreparedStatement ps;
                 ...
                 System.out.println("vaores:"+motivos.size());
                                 
    
                  
                ps=conexion.con.prepareStatement("SELECT e.id_tipo_expediente, e.clave_expediente, e.fecha_apertura_exped, e.fecha_present_promo, e.fecha_admision_promo, p.descripcion AS promovente, es.descripcion AS estatus_expediente, e.fecha_dicto_solucion,  e.comentarios, o.id_organoj, o.nombre_organoj FROM tr_expediente e INNER JOIN tc_promovente p ON e.id_promovente = p.id_promovente INNER JOIN tc_estatus_expediente es ON e.id_estatus_exped = es.id_estatus_expediente INNER JOIN tr_organoj o ON e.id_organoj = o.id_organoj WHERE e.id_tipo_expediente = ? AND e.clave_expediente = ?" );
